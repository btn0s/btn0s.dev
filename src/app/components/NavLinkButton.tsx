...
const NavLinkButton = ({ icon, label, href, isExternal }: INavLink) => {
  return (
    ...
    >
      <li className="group relative inline-flex h-[42px] w-[42px] items-center justify-center gap-1 font-bold active:shadow-inner active:shadow-inner sm:h-full sm:w-auto sm:px-6">
